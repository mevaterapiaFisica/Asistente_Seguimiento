...
public static class AppConfiguration
{
    public static RtSystemConfiguration BuildDefault()
    {
        return new RtSystemConfiguration
        {
            ...
            Stages =
            {
                new ProcessStageDefinition { Code = "F1",  SitraMicroStatus = "planification_request",      DisplayName = "Solicitud de Planificación",    GroupName = "Solicitud",           ExpectedDays = 2, SortOrder =  1 },
                new ProcessStageDefinition { Code = "F2A", SitraMicroStatus = "auth_order_ingress",          DisplayName = "Orden de Autorización Pedida",  GroupName = "Autorización",        ExpectedDays = 3, SortOrder =  5 },
                new ProcessStageDefinition { Code = "F2B", SitraMicroStatus = "auth_order_receive",          DisplayName = "Orden de Autorización Recibida", GroupName = "Autorización",       ExpectedDays = 2, SortOrder =  6 },
                ...
                new ProcessStageDefinition { Code = "F4",  SitraMicroStatus = "no_tomograph_appointment",   DisplayName = "Turno de Tomosimulación",        GroupName = "Tomosimulación",      ExpectedDays = 3, SortOrder = 20 },
                new ProcessStageDefinition { Code = "F4B", SitraMicroStatus = "tomograph",                   DisplayName = "Tomosimulación",                GroupName = "Tomosimulación",      ExpectedDays = 1, SortOrder = 25 },
                new ProcessStageDefinition { Code = "F5",  SitraMicroStatus = "marking",                    DisplayName = "Marcación",                     GroupName = "Marcación",           ExpectedDays = 2, SortOrder = 30 },
                new ProcessStageDefinition { Code = "F6A", SitraMicroStatus = "planification_assign",       DisplayName = "Asignación Planificación",       GroupName = "Planificación",       ExpectedDays = 2, SortOrder = 40 },
                new ProcessStageDefinition { Code = "F6B", SitraMicroStatus = "planification_waiting",      DisplayName = "Esperando Planificación",        GroupName = "Planificación",       ExpectedDays = 2, SortOrder = 41 },
                new ProcessStageDefinition { Code = "F6C", SitraMicroStatus = "planification_medic_ok",     DisplayName = "Aprobación Médica",              GroupName = "Aprobación Médica",   ExpectedDays = 2, SortOrder = 50 },
                new ProcessStageDefinition { Code = "F6D", SitraMicroStatus = "modulation",                  DisplayName = "Sistema Modulación",            GroupName = "Modulación",          ExpectedDays = 3, SortOrder = 55 },
                new ProcessStageDefinition { Code = "F6E", SitraMicroStatus = "waiting_mod_reception",       DisplayName = "Recepción Modulación",           GroupName = "Modulación",          ExpectedDays = 2, SortOrder = 56 },
                ...
                new ProcessStageDefinition { Code = "F6G", SitraMicroStatus = "independent_calculation",    DisplayName = "Cálculo Independiente",          GroupName = "Aprobación Física",   ExpectedDays = 1, SortOrder = 70 },
                new ProcessStageDefinition { Code = "F7A", SitraMicroStatus = "physicist_approval",         DisplayName = "Aprobación Físico",              GroupName = "Aprobación Física",   ExpectedDays = 1, SortOrder = 71 },
                new ProcessStageDefinition { Code = "F7B", SitraMicroStatus = "proteccion_confection",       DisplayName = "Confección de Plomos",           GroupName = "Plomos",              ExpectedDays = 1, SortOrder = 75 },
                ...
                new ProcessStageDefinition { Code = "F10", SitraMicroStatus = "verification_plate_ok_medic", DisplayName = "Ok Médico",                     GroupName = "Placa Verificadora",  ExpectedDays = 1, SortOrder = 110 },
